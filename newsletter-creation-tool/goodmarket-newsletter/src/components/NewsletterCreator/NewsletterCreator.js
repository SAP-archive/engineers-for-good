...
const NewsletterCreator = () => {
    ...
    return (
        <div className="newsletter-container">
            ...
            {/* Header was added for demo purposes
            to be replaced on productive integration*/}
            <div className="main-header">
                <div className="main-header__wrapper">
                    <div className="main-header__menu-container">
                        <img src="/menu.png" alt="Menu Logo" className="main-header__menu-item" />
                    </div>
                    <div className="main-header__logo-container">
                        <img src="/gm.png" alt="GM Logo" className="main-header__logo-item" />
                    </div>
                    <div className="main-header__lang-user-container">
                    </div>
                </div>
            </div>
            ...
            {/* Footer was added for demo purposes
              to be replaced on productive integration*/}
            <div className="footer">
                <div className="footer__item">
                    <div>
                        <img src="/marketplace.png" alt="marketplace Logo" className="footer__item__icon" />
                    </div>
                    <div className="footer__item__icon-name">Marketplace&nbsp;</div>
                </div>
                <div className="footer__item">
                    <div >
                        <img src="/community.png" alt="community Logo" className="footer__item__icon" />
                    </div>
                    <div className="footer__item__icon-name">Community&nbsp;</div>
                </div>
                <div className="footer__item">
                    <div >
                        <img src="/favourites.png" alt="favourites Logo" className="footer__item__icon" />
                    </div>
                    <div className="footer__item__icon-name">Favourites&nbsp;</div>
                </div>
                <div className="footer__item">
                    <div >
                        <img src="/account.png" alt="account Logo" className="footer__item__icon" />
                    </div>
                    <div className="footer__item__icon-name">Account&nbsp;</div>
                </div>
                <div className="footer__item">
                    <div >
                        <img src="/help.png" alt="help Logo" className="footer__item__icon" />
                    </div>
                    <div className="footer__item__icon-name">Help&nbsp;</div>
                </div>
            </div>
        </div>
    )
